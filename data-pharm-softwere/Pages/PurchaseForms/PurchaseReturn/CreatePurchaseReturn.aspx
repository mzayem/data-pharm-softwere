<%@ Page Title="Purchase return" Language="C#" MasterPageFile="~/Pages/Layout.Master" AutoEventWireup="true" CodeBehind="CreatePurchaseReturn.aspx.cs" Inherits="data_pharm_softwere.Pages.PurchaseForms.PurchaseReturn.CreatePurchaseReturn" %>
        ...
        <div class="card shadow-sm rounded-4 p-4">
            ...
            <asp:UpdatePanel ID="upPurchase" runat="server">
                <ContentTemplate>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <h3 class="fw-semibold mb-2">Purchase Return</h3>
                        </div>
                    </div>
